...
import { createVault, getVault, removeVault, reportVaultTampered, updateVault, batchUpdateVault } from "../controllers/vaultController.js";
...
router.post("/batch-update", csrfProtection, batchUpdateVault);
